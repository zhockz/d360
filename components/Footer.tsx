	  		...
	  		<div className="container">
	  			<div className="row d-flex align-items-center">
	  				<div className="col-md-10">
	  					...
	  					<p className="desktop-view">All rights reserved © D360 Bank | Regulated by the Saudi Central Bank|Closed Joint Stock Company with a Capital of SAR 1,650,000,000|CR No. 1010822737 Licensed in accordance with the Council of Ministers decree No. 389 dated 14/07/1443H corresponding to 15/02/2022G|Subject to the supervision of the Saudi Central Bank|3074 Prince Mohammed bin Abdulaziz Rd. Al Olaya Dist. 12213 Riyadh, Saudi Arabia | www.D360.com</p>

	  				</div>

	  				<div className="col-md-2 d-flex justify-content-end desktop-view">
	  					<Link href="">
